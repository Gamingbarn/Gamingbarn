tag @p[tag=player,limit=1] add enderman
...
execute at @a[limit=1,sort=random] run summon enderman ~ ~200 ~ {NoGravity:1b,Invulnerable:1b,PersistenceRequired:1b,NoAI:1b,CanPickUpLoot:0b, Tags:["enderman","p1"]}
