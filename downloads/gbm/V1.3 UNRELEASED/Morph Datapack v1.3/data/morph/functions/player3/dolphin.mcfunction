tag @p[tag=player3,limit=1] add dolphin
...
execute at @a[limit=1,sort=random] run summon dolphin ~ ~200 ~ {NoGravity:1b,Invulnerable:1b,PersistenceRequired:1b,NoAI:1b,CanPickUpLoot:0b, Tags:["dolphin","p4"]}
