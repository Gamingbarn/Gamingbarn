tag @p[tag=player3,limit=1] add cat
...
execute at @a[limit=1,sort=random] run summon cat ~ ~200 ~ {NoGravity:1b,Invulnerable:1b,PersistenceRequired:1b,NoAI:1b,CanPickUpLoot:0b,Tags:["cat","p4"]}
