tag @p[tag=player2,limit=1] add pig
...
execute at @a[limit=1,sort=random] run summon pig ~ ~200 ~ {NoGravity:1b,Invulnerable:1b,PersistenceRequired:1b,NoAI:1b,CanPickUpLoot:0b, Tags:["pig","p3"]}
